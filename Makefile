...
clean_examples:
	# Remove the tables specific for the app
	python backend/manage.py migrate app zero
	# Removing backend app files
	rm -rf ./backend/app
	# Removing frontend app files
	rm -rf ./frontend/js/app/app
